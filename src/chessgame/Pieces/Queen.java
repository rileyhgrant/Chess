  ...
  private void tryCatchSprite() {
    ...
    try {
      ...
      if (this.owner.getIsSmoke() ) {
        inputstream = new FileInputStream("/Users/RileyGrant46/Downloads/blackQueen.png");
      } else {
        inputstream = new FileInputStream("/Users/RileyGrant46/Downloads/whiteQueen.png");
      }
